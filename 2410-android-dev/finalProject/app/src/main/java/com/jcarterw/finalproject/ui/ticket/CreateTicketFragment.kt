...
import com.jcarterw.finalproject.databinding.FragmentCreateTicketBinding
...
//        val CreateTicketViewModel = ViewModelProvider(this).get(CreateTicketViewModel::class.java)
        ...
        val view: View = inflater.inflate(R.layout.fragment_create_ticket, container, false)
